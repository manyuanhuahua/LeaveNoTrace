...
#     ori_lat=db.Column(db.String(100),nullable=False)
#     ori_log=db.Column(db.String(100),nullable=False)
#     des_lat=db.Column(db.String(100),nullable=False)
#     des_log=db.Column(db.String(100),nullable=False)
