...
def seed_trails():
    trail1 = Trail(
        ...
        preview_img = "https://www.americansouthwest.net/california/photographs1118/nevada1.jpg",
        length = 6.00,
        elevation = 2162,
        difficulty = "Hard",
    ...
    trail2 = Trail(
        ...
        preview_img = "https://www.yosemite.com/wp-content/uploads/2016/05/Yosemite-Falls-in-Fall-Autumn.jpg",
        length = 7.60,
        elevation = 3218,
        difficulty = "Hard",
    ...
    trail4 = Trail(
        ...
        preview_img = "https://shesavesshetravels.com/wp-content/uploads/2021/08/mount-rainier-skyline-trail.jpg",
        length = 6.20,
        elevation = 1788,
        difficulty = "Hard",
    ...
    trail7 = Trail(
        ...
        preview_img = "https://wildlandtrekking.com/content/uploads/2020/03/image8-1-3.jpg",
        length = 1.9,
        elevation = 193,
        difficulty = "Easy",
        lat = 37.306373195477,
    ...
    trail15 = Trail(
        ...
        preview_img = "https://s.hdnux.com/photos/01/30/07/06/23097732/1/1082x0.jpg",
        length = 7.5,
        elevation = 1689,
        difficulty = "Moderate",
    ...
    trail19 = Trail(
        ...
        description = "This is a very popular area for birding, hiking, and mountain biking, so you'll likely encounter other people while exploring. The best times to visit this trail are June through October. Dogs are welcome and may be off-leash in some areas.",
        preview_img = "https://californiathroughmylens.com/wp-content/uploads/2019/10/temescal-canyon-17-640x427.jpg",
        length = 3.8,
        elevation = 935,
        difficulty = "Moderate",
